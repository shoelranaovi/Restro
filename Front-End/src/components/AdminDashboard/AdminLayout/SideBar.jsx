            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              {selectedTab === "dashboard" && (
                <div className="mt-4 md:mt-0">
                  <button className="px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Generate Report
                  </button>
                </div>
              )}
